...
arguments:
  ...
  - position: 1
    prefix: -p
    valueFrom: $(inputs.MAIN_PATH)/$(inputs.tree[0])-($(inputs.scientific_name[0])-$(inputs.scientific_name[1]))/$(inputs.tree[1])/1.Genome Assembly/$(inputs.tree[1])/agp
  - position: 2
    valueFrom: $(inputs.MAIN_PATH)/$(inputs.tree[0])-($(inputs.scientific_name[0])-$(inputs.scientific_name[1]))/$(inputs.tree[1])/1.Genome Assembly/$(inputs.tree[1])/Contigs
  - position: 3
  ...
  - position: 5
    valueFrom: $(inputs.MAIN_PATH)/$(inputs.tree[0])-($(inputs.scientific_name[0])-$(inputs.scientific_name[1]))/$(inputs.tree[1])/3.Additional Gene Sets and Annotation Projects
  #Transcriptomes and RNA-Seq
  - position: 6
    valueFrom: $(inputs.MAIN_PATH)/$(inputs.tree[0])-($(inputs.scientific_name[0])-$(inputs.scientific_name[1]))/$(inputs.tree[1])/4.Transcriptomes and RNA-Seq
  #Other Files
  - position: 7
